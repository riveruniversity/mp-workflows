Contacts.[Contact_ID], Contacts.[Nickname] AS [First Name], Contacts.[Last_Name], 
...
(SELECT COALESCE((
    SELECT TOP 1 
      CASE 
        ...
        WHEN All_Clear = 'false' THEN '<a style="text-decoration:none;color:#475466;" href="https://mp.revival.com/mp/292-2502/'+ CONVERT(varchar(10), Contacts.Contact_ID) +'/511/'+ CONVERT(varchar(10), Background_Check_ID) + N'">🚩 Flags</a>' 
